...
1. **Query Rewriting:** The user's query is expanded using an LLM (e.g. converting _"why did deploy fail?"_ into search terms like `"Error", "deployment", "pipeline aborted", "failed"`).
2. **Hybrid Search:**
